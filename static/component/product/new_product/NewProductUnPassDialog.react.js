...
var NewProductUnPassDialogStore = require('./NewProductUnPassDialogStore');
var Constant = require('./Constant');
var Action = require('./Action');
require('./NewProductUnPassDialog.css')

var NewProductUnPassDialog = Reactman.createDialog({
	getInitialState: function() {
		NewProductUnPassDialogStore.addListener(this.onChangeStore);
		var productId = this.props.data.product_id;
		return {
			product_id: productId,
			reasons: NewProductUnPassDialogStore.getData().reasons,
			custom_reason: ''
		}
	},
	...
	onChangeStore: function(){
		var infomations = NewProductUnPassDialogStore.getData();
		this.setState({
			...
			<div className="xui-formPage">
				<form className="form-horizontal mt15">
					<fieldset>
						...
						<a href="javascript:void(0);" className="btn btn-success" style={{marginLeft:'245px', managerTop:'20px'}} onClick={this.refused}><span>确定</span></a>
