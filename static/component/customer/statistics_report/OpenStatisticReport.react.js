		...
		return (
			<div className="mt15 xui-product-productListPage">
				...
				<Reactman.Table resource={productsResource} formatter={this.rowFormatter} ref="table">
					...
					<Reactman.TableColumn name="居委汇" field="weizoom_juweihui" />
					<Reactman.TableColumn name="微众中海" field="weizoom_zhonghai" />
				...
				<Reactman.Table resource={datesResource} formatter={this.rowFormatter} ref="table">
					...
					<Reactman.TableColumn name="居委汇" field="weizoom_juweihui_orders_number" />
					<Reactman.TableColumn name="微众中海" field="weizoom_zhonghai_orders_number" />
				</Reactman.Table>
			</div>
		)
	}
