...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		uglify: {
            ...
            buildjs: {
	            ...
	            files: {
	            	'build/cdn/panda_static/js/lib.min.js': ['build/cdn/panda_static/js/lib.js']
	            }
            }
		},
		cssmin: {
			buildcss: {
				...
				files: {
					'build/cdn/panda_static/css/all.min.css': ['build/cdn/panda_static/css/all.css']
				}
			}
		},
		md5: {
		    digest_css: {
		    	files: {
		    		'build/cdn/panda_static/css/': 'build/cdn/panda_static/css/all.min.css'
		    	},
		    	options: {
		    		keepBasename: true,
		    		keepExtension: true,
		    ...
		    digest_js: {
		    	files: {
		    		'build/cdn/panda_static/js/': 'build/cdn/panda_static/js/lib.min.js'
		    	},
		    	options: {
		    		keepBasename: true,
		    		keepExtension: true,
	...
	grunt.registerTask('modify-mode', function() {
		var filePath = './dist/panda/settings.py';
